...
[`pidof`](https://frippery.org/busybox/BusyBox.html#pidof)                 | поиск process ID запущенной программы
...
[`sync`](https://frippery.org/busybox/BusyBox.html#sync)                   | сброс (синхронизация) дисковых кэшей
...
[`tee`](https://frippery.org/busybox/BusyBox.html#tee)                     | чтение из стандартного ввода и запись и в стандартный вывод, и в файлы
...
[`watch`](https://frippery.org/busybox/BusyBox.html#watch)                 | периодическое выполнение программы с отображением вывода fullscreen
