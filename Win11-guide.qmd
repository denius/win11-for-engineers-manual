...
* `-h` -- [h]uman, размер в _Kb (KiB)_, _Mb (MiB)_, и т.д., а не в байтах;
...
_Note:_ Для PowerShell смотри соответствующий пункт главы [Настройки Windows Terminal](#настройка-windows-terminal).
