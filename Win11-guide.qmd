...
* [Opening PuTTY in Windows Terminal](<https://github.com/microsoft/terminal/issues/1917#issuecomment-686786806) (может уже исправили).
...
Установить [**Julia**](https://julialang.org/):
```sh
...
# **Этап 4: Приложения с ненужными программами** {.unnumbered .unlisted}
