...
: Указание [размеров изображения](https://imagemagick.org/script/command-line-processing.php#geometry) для утилит _ImageMagick_ (далее показаны на примерах). {tbl-colwidths="[15,85]"}
