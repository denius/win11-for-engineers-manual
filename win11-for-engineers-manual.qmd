...
* _Coder_ модели для программирования, могут применяться как в составе сред разработки, так и писать код по запросу;
