...
В отчёте на консоль, скрипт должен отправлять в каждой строке данные, разделённые пробелами:

* порядковый номер;
* суммарная, накопленная к этому моменту масса, в [gramm];
* момент времени, [s].

Комментарии в скрипте должны быть на английском.
