...
for package_str in julia_packages
    ...
    try
        ...
        # Если не установлен, добавляем и загружаем снова
        Pkg.add(package_str)
        eval(:(using $package))
    end
end
...
# Проверка и установка Python-пакетов через CondaPkg
for package in python_packages
    try
        # Попытка импортировать Python-пакет
        pyimport(package)
    catch
        # Если не установлен, добавляем через CondaPkg
