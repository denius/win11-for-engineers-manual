...
### Примеры моделей {.unnumbered .unlisted}

* Современные [MoE модели](https://llm.extractum.io/list/?moe=), например [Qwen3-30B-A3B](https://ollama.com/library/qwen3), очень хорошо справляются с большинством типов задач.
...
* Для математики и формул лучше всего работают _Reasoning_ модели, например [DeepSeek R1](https://ollama.com/library/deepseek-r1).
