...
_Note:_ Есть поддержка режима редактирования Vim в плагине _CodeMirror Keymap Vim_. Но для _очень_ продвинутых пользователей этот плагин не актален, так как они уже настроили себе расширение <https://github.com/glacambre/firenvim>.
