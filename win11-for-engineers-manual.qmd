...
```
Пока не пофиксят этот [баг](https://github.com/rmyorston/busybox-w32/issues/17), данную процедуру придётся повторять после каждого обновления _BusyBox_ или _git_, благо такие обновления могут быть проведены только вручную командой `scoop update --all`.
