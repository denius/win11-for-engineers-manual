...
Легко представить, как набором нескольких вопросов можно сформировать *"среду"* для выполнения какой-то конкретной, специфической задачи, где всё будет заточено под необходимый контекст, и любые новые вопросы будут интерпретироваться исключительно в заданных рамках.
