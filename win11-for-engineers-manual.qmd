...
При слиянии веток возможно возникнут конфликты, если файлы в исходном репозитории изменились после создания ветки *branch-name*. В этом случае git предложит провести трёхстороннее слияние в meld или winmerge. После слияния изменения в файле или файлы будут сохранены в новом коммите.
