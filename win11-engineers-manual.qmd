...
_Fedora_ имеет преимущество перед _Ubuntu_, так как _RedHat_/_Fedora_ изначально ориентированный на _HPC_ Linux дистрибутив, и в нём лучше поддержка параллелизации, отладки Fortran, и прочим разделам высокопроизводительных вычислений.
